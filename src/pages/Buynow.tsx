            ...
            <Card className="w-full max-w-2xl shadow-xl rounded-lg p-6">
                ...
                <Form form={form} layout="vertical" onFinish={handleOrderSubmit}>
                    ...
                    <Text strong className="block text-lg">
                        Total Price: <span className="text-green-600">${car.price * quantity}</span>
                    </Text>

                    <div className="flex justify-center mt-4">
                        <Button type="primary" htmlType="submit" className="bg-blue-500 hover:bg-blue-700 text-white px-6 py-2 rounded-lg">
                            Order Now
                        </Button>
                    </div>
                </Form>
